...
//
// On Thu Jul 13 18:53:04 EDT 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkUARTSpec(cfg,
  ...
  wire CAN_FIRE_RL_u_rx_data,
       CAN_FIRE_RL_u_rx_parity,
       CAN_FIRE_RL_u_rx_rx_f_upd_count,
       CAN_FIRE_RL_u_rx_rxd_old,
       CAN_FIRE_RL_u_rx_start,
       CAN_FIRE_RL_u_rx_stop,
       CAN_FIRE_RL_u_rx_ticker_update_counter,
       CAN_FIRE_RL_u_rx_wait_for_start,
       CAN_FIRE_RL_u_rx_write_data,
       CAN_FIRE_RL_u_tx_data,
       CAN_FIRE_RL_u_tx_parity,
       CAN_FIRE_RL_u_tx_start,
       CAN_FIRE_RL_u_tx_stop,
       CAN_FIRE_RL_u_tx_ticker_update_counter,
       CAN_FIRE_clear,
       CAN_FIRE_pins_cts,
       CAN_FIRE_pins_rxd,
       CAN_FIRE_rx,
       ...
       WILL_FIRE_RL_u_rx_rx_f_upd_count,
       WILL_FIRE_RL_u_rx_rxd_old,
       WILL_FIRE_RL_u_rx_start,
       WILL_FIRE_RL_u_rx_stop,
       WILL_FIRE_RL_u_rx_ticker_update_counter,
       ...
       WILL_FIRE_RL_u_tx_ticker_update_counter,
       WILL_FIRE_clear,
       WILL_FIRE_pins_cts,
       WILL_FIRE_pins_rxd,
       WILL_FIRE_rx,
  ...
  // action method pins_rxd
  assign CAN_FIRE_pins_rxd = 1'd1 ;
  assign WILL_FIRE_pins_rxd = 1'd1 ;

  // value method pins_rts
  assign pins_rts = u_rx_rx_f_r_count >= 4'd4 ;

  // action method pins_cts
  assign CAN_FIRE_pins_cts = 1'd1 ;
  assign WILL_FIRE_pins_cts = 1'd1 ;
  ...
  assign CAN_FIRE_rx = u_rx_rx_f_rx_f$EMPTY_N ;
  assign WILL_FIRE_rx = EN_rx ;

  // action method tx
  assign RDY_tx = u_tx_tx_f$FULL_N ;
  assign CAN_FIRE_tx = u_tx_tx_f$FULL_N ;
  assign WILL_FIRE_tx = EN_tx ;
  ...
  assign CAN_FIRE_RL_u_rx_write_data =
	     u_rx_rx_f_rx_f$FULL_N &&
	     (u_rx_state == 3'd1 || u_rx_state == 3'd4) &&
	     u_rx_curr_rx_valid ;
  assign WILL_FIRE_RL_u_rx_write_data = CAN_FIRE_RL_u_rx_write_data ;

  // rule RL_u_rx_wait_for_start
  assign CAN_FIRE_RL_u_rx_wait_for_start =
	     u_rx_state == 3'd0 && !pins_rxd && u_rx_r_rxd_old ;
  assign WILL_FIRE_RL_u_rx_wait_for_start = CAN_FIRE_RL_u_rx_wait_for_start ;

  // rule RL_u_rx_rxd_old
  assign CAN_FIRE_RL_u_rx_rxd_old = 1'd1 ;
  assign WILL_FIRE_RL_u_rx_rxd_old = 1'd1 ;

  // rule RL_u_rx_start
  assign CAN_FIRE_RL_u_rx_start =
	     u_rx_state == 3'd1 && u_rx_ticker_counter == 16'd0 ;
  assign WILL_FIRE_RL_u_rx_start = CAN_FIRE_RL_u_rx_start ;

  // rule RL_u_rx_data
  assign CAN_FIRE_RL_u_rx_data =
	     u_rx_state == 3'd2 && u_rx_ticker_counter == 16'd0 ;
  assign WILL_FIRE_RL_u_rx_data = CAN_FIRE_RL_u_rx_data ;

  // rule RL_u_rx_parity
  assign CAN_FIRE_RL_u_rx_parity =
	     u_rx_state == 3'd3 && u_rx_ticker_counter == 16'd0 ;
  assign WILL_FIRE_RL_u_rx_parity = CAN_FIRE_RL_u_rx_parity ;

  // rule RL_u_rx_stop
  assign CAN_FIRE_RL_u_rx_stop =
	     u_rx_state == 3'd4 && u_rx_ticker_counter == 16'd0 ;
  assign WILL_FIRE_RL_u_rx_stop = CAN_FIRE_RL_u_rx_stop ;

  // rule RL_u_rx_ticker_update_counter
  assign CAN_FIRE_RL_u_rx_ticker_update_counter = 1'd1 ;
  assign WILL_FIRE_RL_u_rx_ticker_update_counter = 1'd1 ;

  // rule RL_u_tx_stop
  assign CAN_FIRE_RL_u_tx_stop =
	     u_tx_ticker_counter == 16'd0 && u_tx_state == 2'd3 ;
  assign WILL_FIRE_RL_u_tx_stop = CAN_FIRE_RL_u_tx_stop ;

  // rule RL_u_tx_start
  assign CAN_FIRE_RL_u_tx_start =
	     u_tx_tx_f$EMPTY_N && u_tx_ticker_counter == 16'd0 &&
	     u_tx_state == 2'd0 ;
  assign WILL_FIRE_RL_u_tx_start = CAN_FIRE_RL_u_tx_start ;

  // rule RL_u_rx_rx_f_upd_count
  assign CAN_FIRE_RL_u_rx_rx_f_upd_count =
	     EN_clear || CAN_FIRE_RL_u_rx_write_data != EN_rx ;
  assign WILL_FIRE_RL_u_rx_rx_f_upd_count = CAN_FIRE_RL_u_rx_rx_f_upd_count ;

  // rule RL_u_tx_data
  assign CAN_FIRE_RL_u_tx_data =
	     u_tx_ticker_counter == 16'd0 && u_tx_state == 2'd1 ;
  assign WILL_FIRE_RL_u_tx_data = CAN_FIRE_RL_u_tx_data ;

  // rule RL_u_tx_parity
  assign CAN_FIRE_RL_u_tx_parity =
	     u_tx_ticker_counter == 16'd0 && u_tx_state == 2'd2 ;
  assign WILL_FIRE_RL_u_tx_parity = CAN_FIRE_RL_u_tx_parity ;

  // rule RL_u_tx_ticker_update_counter
  assign CAN_FIRE_RL_u_tx_ticker_update_counter = 1'd1 ;
  assign WILL_FIRE_RL_u_tx_ticker_update_counter = 1'd1 ;
  ...
  assign u_rx_bit_count$EN = CAN_FIRE_RL_u_rx_data ;

  // register u_rx_curr_rx
  assign u_rx_curr_rx$D_IN = { pins_rxd, u_rx_curr_rx[7:1] } ;
  assign u_rx_curr_rx$EN = CAN_FIRE_RL_u_rx_data ;
  ...
  assign u_rx_rx_f_r_count$D_IN =
	     EN_clear ?
		  ...
		  u_rx_rx_f_r_count - 4'd1) ;
  assign u_rx_rx_f_r_count$EN = CAN_FIRE_RL_u_rx_rx_f_upd_count ;
  ...
  assign u_tx_bit_count$EN = CAN_FIRE_RL_u_tx_data ;
  ...
  assign u_rx_rx_f_rx_f$ENQ = CAN_FIRE_RL_u_rx_write_data ;
  ...
  assign u_tx_tx_f$DEQ = CAN_FIRE_RL_u_tx_start ;
