...
//
// On Thu Jul 13 18:53:11 EDT 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkML605Test(CLK,
  ...
  // action method uart_rxd
  assign CAN_FIRE_uart_rxd = 1'd1 ;
  assign WILL_FIRE_uart_rxd = 1'd1 ;

  // value method uart_rts
  assign uart_rts = m$uart_pins_rts ;

  // action method uart_cts
  assign CAN_FIRE_uart_cts = 1'd1 ;
  assign WILL_FIRE_uart_cts = 1'd1 ;
