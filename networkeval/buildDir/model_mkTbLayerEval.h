...
/* Generation options: */
#ifndef __model_mkTbLayerEval_h__
#define __model_mkTbLayerEval_h__
...
/* Class declaration for a model of mkTbLayerEval */
class MODEL_mkTbLayerEval : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTbLayerEval *mkTbLayerEval_instance;
...
#endif /* ifndef __model_mkTbLayerEval_h__ */
