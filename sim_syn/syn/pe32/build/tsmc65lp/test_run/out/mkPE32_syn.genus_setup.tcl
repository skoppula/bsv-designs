...
###########################################################
if {[::legacy::find -design design:mkPE32] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:mkPE32
}


# Source INIT Setup file
########################################################
source build/tsmc65lp/test_run/out/mkPE32_syn.genus_init.tcl
read_metric -id current build/tsmc65lp/test_run/out/mkPE32_syn.metrics.json

source build/tsmc65lp/test_run/out/mkPE32_syn.g
read_tcf build/tsmc65lp/test_run/out/mkPE32_syn.tcf
...
# slack
set _slk_ [::legacy::get_attribute slack design:mkPE32]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns design:mkPE32]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:mkPE32]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:mkPE32]
