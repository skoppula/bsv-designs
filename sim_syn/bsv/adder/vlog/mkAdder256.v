...
module mkAdder256(CLK,
  ...
  // submodule m_a
  FIFOL1 #(.width(32'd256)) m_a(.RST(RST_N),
				.CLK(CLK),
				.D_IN(m_a_D_IN),
				.ENQ(m_a_ENQ),
				.DEQ(m_a_DEQ),
  ...
  // submodule m_b
  FIFOL1 #(.width(32'd256)) m_b(.RST(RST_N),
				.CLK(CLK),
				.D_IN(m_b_D_IN),
				.ENQ(m_b_ENQ),
				.DEQ(m_b_DEQ),
  ...
  // submodule m_c
  FIFOL1 #(.width(32'd256)) m_c(.RST(RST_N),
				.CLK(CLK),
				.D_IN(m_c_D_IN),
				.ENQ(m_c_ENQ),
				.DEQ(m_c_DEQ),
  ...
  // submodule m_a
  assign m_a_D_IN = request_put[511:256] ;
  assign m_a_ENQ = EN_request_put ;
  assign m_a_DEQ = CAN_FIRE_RL_m_add ;
  assign m_a_CLR = 1'b0 ;

  // submodule m_b
  assign m_b_D_IN = request_put[255:0] ;
