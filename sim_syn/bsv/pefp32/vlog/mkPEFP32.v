...
// CLK                            I     1 clock
// RST_N                          I     1 reset
// load_weights_weights           I   256 reg
// add_input_inp                  I     8
...
module mkPEFP32(CLK,
  ...
  reg [31 : 0] m_partial_sum;
  reg [31 : 0] m_partial_sum_D_IN;
  ...
  reg [31 : 0] m_weight_regs_0;
  wire [31 : 0] m_weight_regs_0_D_IN;
  wire m_weight_regs_0_EN;

  // register m_weight_regs_1
  reg [31 : 0] m_weight_regs_1;
  wire [31 : 0] m_weight_regs_1_D_IN;
  wire m_weight_regs_1_EN;

  // register m_weight_regs_2
  reg [31 : 0] m_weight_regs_2;
  wire [31 : 0] m_weight_regs_2_D_IN;
  wire m_weight_regs_2_EN;

  // register m_weight_regs_3
  reg [31 : 0] m_weight_regs_3;
  wire [31 : 0] m_weight_regs_3_D_IN;
  wire m_weight_regs_3_EN;

  // register m_weight_regs_4
  reg [31 : 0] m_weight_regs_4;
  wire [31 : 0] m_weight_regs_4_D_IN;
  wire m_weight_regs_4_EN;

  // register m_weight_regs_5
  reg [31 : 0] m_weight_regs_5;
  wire [31 : 0] m_weight_regs_5_D_IN;
  wire m_weight_regs_5_EN;

  // register m_weight_regs_6
  reg [31 : 0] m_weight_regs_6;
  wire [31 : 0] m_weight_regs_6_D_IN;
  wire m_weight_regs_6_EN;

  // register m_weight_regs_7
  reg [31 : 0] m_weight_regs_7;
  wire [31 : 0] m_weight_regs_7_D_IN;
  ...
  assign get_partial_sum =
	     (!m_partial_sum[31] &&
	      (m_partial_sum[17] || m_partial_sum[31:18] != 14'd0)) ?
	       8'd127 :
	       ((m_partial_sum[31] &&
		 (!m_partial_sum[17] || ~m_partial_sum[31:18] != 14'd0)) ?
		  8'd128 :
  ...
  assign MUX_m_partial_sum_write_1__VAL_2 =
	     (!m_partial_sum[31] &&
	      !IF_NOT_IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BIT_ETC___d92[31] &&
	      m_partial_sum_PLUS_IF_NOT_IF_NOT_IF_SEL_ARR_m__ETC___d96[31]) ?
	       32'h7FFFFFFF :
	       ((m_partial_sum[31] &&
		 IF_NOT_IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BIT_ETC___d92[31] &&
		 !m_partial_sum_PLUS_IF_NOT_IF_NOT_IF_SEL_ARR_m__ETC___d96[31]) ?
  ...
  assign MUX_m_partial_sum_write_1__VAL_3 =
	     m_partial_sum[31] ? 32'd0 : m_partial_sum ;
  assign MUX_m_partial_sum_write_1__VAL_4 =
	     m_partial_sum + { in2_i__h7236, in2_f__h7237 } ;
  ...
  case (1'b1)
    EN_reset_pe: m_partial_sum_D_IN = 32'd0;
    ...
    default: m_partial_sum_D_IN = 32'hAAAAAAAA /* unspecified value */ ;
  endcase
  assign m_partial_sum_EN =
	     EN_add_constant || EN_add_input || EN_nonlinearity ||
	     EN_reset_pe ;
  ...
  // register m_weight_regs_0
  assign m_weight_regs_0_D_IN = load_weights_weights[31:0] ;
  assign m_weight_regs_0_EN = EN_load_weights ;

  // register m_weight_regs_1
  assign m_weight_regs_1_D_IN = load_weights_weights[63:32] ;
  assign m_weight_regs_1_EN = EN_load_weights ;

  // register m_weight_regs_2
  assign m_weight_regs_2_D_IN = load_weights_weights[95:64] ;
  assign m_weight_regs_2_EN = EN_load_weights ;

  // register m_weight_regs_3
  assign m_weight_regs_3_D_IN = load_weights_weights[127:96] ;
  assign m_weight_regs_3_EN = EN_load_weights ;

  // register m_weight_regs_4
  assign m_weight_regs_4_D_IN = load_weights_weights[159:128] ;
  assign m_weight_regs_4_EN = EN_load_weights ;

  // register m_weight_regs_5
  assign m_weight_regs_5_D_IN = load_weights_weights[191:160] ;
  assign m_weight_regs_5_EN = EN_load_weights ;

  // register m_weight_regs_6
  assign m_weight_regs_6_D_IN = load_weights_weights[223:192] ;
  assign m_weight_regs_6_EN = EN_load_weights ;

  // register m_weight_regs_7
  assign m_weight_regs_7_D_IN = load_weights_weights[255:224] ;
  ...
  assign IF_NOT_IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BIT_ETC___d92 =
	     (!IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[47] &&
	      (IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[31] ||
	       IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[47:32] !=
	       16'd0)) ?
	       32'h7FFFFFFF :
	       ((IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[47] &&
		 (!IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[31] ||
		  ...
		  16'd0)) ?
		  32'h80000000 :
		  IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75[31:0]) ;
  assign IF_NOT_IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_ETC___d75 =
	     (!IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60[63] &&
	      IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d72[47]) ?
	       48'h7FFFFFFFFFFF :
	       IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d72 ;
  assign IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d58 =
	     x__h3566 * x__h3585 ;
  assign IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60 =
	     (weight_se_i__h3450[15] && !inp_se_i__h3534[15] ||
	      inp_se_i__h3534[15] && !weight_se_i__h3450[15]) ?
	       -IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d58 :
	       IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d58 ;
  assign IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d72 =
	     IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60[63:16] +
	     { 32'd0, y_f__h4641 } ;
  ...
  assign in2_f__h7237 = { add_constant_constant[5:0], 10'd0 } ;
  assign in2_i__h7236 =
	     { {14{add_constant_constant_BITS_7_TO_6__q2[1]}},
	       add_constant_constant_BITS_7_TO_6__q2 } ;
  assign inp_se_f__h3535 = { add_input_inp[5:0], 10'd0 } ;
  assign inp_se_i__h3534 =
  ...
  assign x__h3566 = weight_se_i__h3450[15] ? -x__h3582 : x__h3582 ;
  assign x__h3582 = { weight_se_i__h3450, weight_se_f__h3451 } ;
  assign x__h3585 = inp_se_i__h3534[15] ? -x__h3601 : x__h3601 ;
  assign x__h3601 = { inp_se_i__h3534, inp_se_f__h3535 } ;
  assign y_f__h4641 =
	     (IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60[15] &&
	      (IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60[63] ||
	       IF_SEL_ARR_m_weight_regs_0_2_BITS_31_TO_16_3_m_ETC___d60[14:0] !=
	       15'd0)) ?
	       16'd1 :
	       16'd0 ;
  always@(m_step or
  ...
  begin
    case (m_step)
      4'd0: weight_se_i__h3450 = m_weight_regs_0[31:16];
      4'd1: weight_se_i__h3450 = m_weight_regs_1[31:16];
      4'd2: weight_se_i__h3450 = m_weight_regs_2[31:16];
      4'd3: weight_se_i__h3450 = m_weight_regs_3[31:16];
      4'd4: weight_se_i__h3450 = m_weight_regs_4[31:16];
      4'd5: weight_se_i__h3450 = m_weight_regs_5[31:16];
      4'd6: weight_se_i__h3450 = m_weight_regs_6[31:16];
      4'd7: weight_se_i__h3450 = m_weight_regs_7[31:16];
      default: weight_se_i__h3450 =
  ...
  begin
    case (m_step)
      4'd0: weight_se_f__h3451 = m_weight_regs_0[15:0];
      4'd1: weight_se_f__h3451 = m_weight_regs_1[15:0];
      4'd2: weight_se_f__h3451 = m_weight_regs_2[15:0];
      4'd3: weight_se_f__h3451 = m_weight_regs_3[15:0];
      4'd4: weight_se_f__h3451 = m_weight_regs_4[15:0];
      4'd5: weight_se_f__h3451 = m_weight_regs_5[15:0];
      4'd6: weight_se_f__h3451 = m_weight_regs_6[15:0];
      4'd7: weight_se_f__h3451 = m_weight_regs_7[15:0];
      default: weight_se_f__h3451 =
		   16'b1010101010101010 /* unspecified value */ ;
    endcase
  end
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        m_partial_sum <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_step <= `BSV_ASSIGNMENT_DELAY 4'd0;
	m_weight_regs_0 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_1 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_2 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_3 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_4 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_5 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_6 <= `BSV_ASSIGNMENT_DELAY 32'd0;
	m_weight_regs_7 <= `BSV_ASSIGNMENT_DELAY 32'd0;
      end
    else
      begin
        if (m_partial_sum_EN)
  ...
  initial
  begin
    m_partial_sum = 32'hAAAAAAAA;
    m_step = 4'hA;
    m_weight_regs_0 = 32'hAAAAAAAA;
    m_weight_regs_1 = 32'hAAAAAAAA;
    m_weight_regs_2 = 32'hAAAAAAAA;
    m_weight_regs_3 = 32'hAAAAAAAA;
    m_weight_regs_4 = 32'hAAAAAAAA;
    m_weight_regs_5 = 32'hAAAAAAAA;
    m_weight_regs_6 = 32'hAAAAAAAA;
    m_weight_regs_7 = 32'hAAAAAAAA;
  end
