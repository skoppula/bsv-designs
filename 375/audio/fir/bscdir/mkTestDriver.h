...
class MOD_mkTestDriver : public Module {
 ...
 public:
  ...
  MOD_mkMultiplier INST_pipeline_multipliers_0;
  MOD_mkMultiplier INST_pipeline_multipliers_1;
  MOD_mkMultiplier INST_pipeline_multipliers_2;
  MOD_mkMultiplier INST_pipeline_multipliers_3;
  MOD_mkMultiplier INST_pipeline_multipliers_4;
  MOD_mkMultiplier INST_pipeline_multipliers_5;
  MOD_mkMultiplier INST_pipeline_multipliers_6;
  MOD_mkMultiplier INST_pipeline_multipliers_7;
  MOD_mkMultiplier INST_pipeline_multipliers_8;
  ...
  MOD_Reg<tUInt8> INST_pipeline_submit;
 ...
 public:
  ...
  tUInt8 DEF_WILL_FIRE_RL_pipeline_getMultiplication;
  tUInt8 DEF_CAN_FIRE_RL_pipeline_getMultiplication;
  tUInt8 DEF_WILL_FIRE_RL_pipeline_process;
  tUInt8 DEF_CAN_FIRE_RL_pipeline_process;
 
 /* Local definitions */
 private:
  tUInt32 DEF_b__h7655;
  tUInt32 DEF_x__h7809;
  tUInt32 DEF_TASK_fopen___d75;
  tUInt32 DEF_TASK_fopen___d73;
  tUInt32 DEF_m_out___d100;
 
 /* Rules */
 public:
  void RL_pipeline_process();
  void RL_pipeline_getMultiplication();
  void RL_init();
  void RL_read();
  void RL_write();
  void RL_finish();
